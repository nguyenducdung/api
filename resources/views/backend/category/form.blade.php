        ...
        <div class="col-12">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">@if(isset($info)) Sửa @else Tạo @endif loại món ăn</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  <form method="post" @if(isset($info)) action="{{route('category.update',$info->id)}}" @else action="{{route('category.store')}}" @endif>
                      @csrf
